...
import { createEquipos,deleteEquipos,updateEquipos, getEquipos} from '../controllers/equipo.controllers';
...
router.get('/equipos', authenticateJWT, verifyAdminRole, getEquipos);
